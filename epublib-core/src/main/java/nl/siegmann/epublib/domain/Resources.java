...
public class Resources implements Serializable {
    ...
    /**
     * Adds a resource to the resources. Fixes the resources id and href if
     * necessary.
     * 
     * @param resource
     * @return
    ...
    /**
     * Checks the id of the given resource and changes to a unique identifier if
    ...
    /**
     * Check if the id is a valid identifier. if not: prepend with valid
     * identifier
     * 
     * @param resource
     * @return
    ...
    /**
     * Whether the map of resources already contains a resource with the given
     * id.
     * 
     * @param id
     * @return
    ...
    /**
     * The resources that make up this book. Resources can be xhtml pages,
     * images, xml documents, etc.
     * 
     * @return
     */
    ...
    public boolean containsByHref(String href) {
        ...
        return resources.containsKey(StringUtil.substringBefore(href,
     ...
     * Sets the collection of Resources to the given collection of resources
     * 
     * @param resources A map with as keys the resources href and as values the
     *            Resources
     */
    ...
    /**
     * Gets the resource with the given href. If the given href contains a
     * fragmentId then that fragment id will be ignored.
     * 
     * @param href
     * @return null if not found.
     */
    ...
    /**
     * Gets the first resource (random order) with the give mediatype. Useful
     * for looking up the table of contents as it's supposed to be the only
     * resource with NCX mediatype.
     * 
     * @param mediaType
     * @return
     */
